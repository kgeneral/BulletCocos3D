...
#import "BulletCocos3DAppDelegate.h"
#import "BulletCocos3DLayer.h"
#import "BulletCocos3DScene.h"
#import "CC3CC2Extensions.h"

#define kAnimationFrameRate		60		// Animation frame rate

@implementation BulletCocos3DAppDelegate {
	UIWindow* _window;
...
//	_viewController.isOverlayingDeviceCamera = YES;
	...
	CC3Layer* cc3Layer = [BulletCocos3DLayer node];
	
	// Create the customized 3D scene and attach it to the layer.
	// Could also just create this inside the customer layer.
	cc3Layer.cc3Scene = [BulletCocos3DScene scene];
